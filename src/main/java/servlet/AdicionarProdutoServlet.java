...
public class AdicionarProdutoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (nomeProduto != null && !nomeProduto.isEmpty() && codigoProduto != null && !codigoProduto.isEmpty()
				&& validadeProduto != null && !validadeProduto.isEmpty() && quantidadeProduto != null
				&& !quantidadeProduto.isEmpty() && precoProduto != null && !precoProduto.isEmpty()) {

			boolean produtoExiste = daoProduto.BuscarProdutoBool(codigoProduto);

			if (!produtoExiste) {
				daoProduto.AdicionarProduto(nomeProduto, codigoProduto, validadeProduto, quantidadeProduto,
						precoProduto);
